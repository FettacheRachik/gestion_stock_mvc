									...
									<tbody>
										<c:forEach items="${categories }" var="cat">
											<tr class="odd gradeX">
												...
												<td><c:url
														value="/category/modifier/${cat.idCategory }"
													...
													data-target="#modalCategory${cat.idCategory }"><i
														class="fa fa-trash-o"></i></a>
													<div class="modal fade"
														id="modalCategory${cat.idCategory}" tabindex="-1"
														...
														<div class="modal-dialog">
															<div class="modal-content">
																...
																<div class="modal-footer">
																	...
																	<c:url
																		value="/category/supprimer/${cat.idCategory}"
																		var="urlSuppression" />
