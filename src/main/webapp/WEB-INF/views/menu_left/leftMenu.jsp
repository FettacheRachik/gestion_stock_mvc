...
<div class="navbar-default sidebar" role="navigation">
	<div class="sidebar-nav navbar-collapse">
		<ul class="nav" id="side-menu">
			...
			<li><a href="${article}"><i class="fa fa-barcode fa-fw"></i> <fmt:message
						key="common.article" /> </a></li>
			<li><a href="#"><i class="fa fa-users fa-fw"></i> <fmt:message
			...
			<li><a href="${vente}"><i class="fa fa-wrench fa-fw"></i>
